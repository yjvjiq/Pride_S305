###########################################################################
## Makefile generated for Simulink model 'SOF176Ah'. 
## 
## Makefile     : SOF176Ah.mk
## Generated on : Tue Dec 20 17:38:18 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: ./SOF176Ah_rtwlib.lib
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = SOF176Ah_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = SOF176Ah_ref.rsp
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/slprj/ert/SOF176Ah -I$(START_DIR) -ID:/Ä£ÐÍ -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=SOF176Ah -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/SOF176Ah/SOF176Ah.c
...
%.obj : $(START_DIR)/slprj/ert/SOF176Ah/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
