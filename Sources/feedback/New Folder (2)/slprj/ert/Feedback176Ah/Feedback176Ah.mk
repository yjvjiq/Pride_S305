###########################################################################
## Makefile generated for Simulink model 'Feedback176Ah'. 
## 
## Makefile     : Feedback176Ah.mk
## Generated on : Tue Dec 20 17:38:12 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: ./Feedback176Ah_rtwlib.lib
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Feedback176Ah_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = Feedback176Ah_ref.rsp
...
MODELLIB                  = Feedback176Ah_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
SHARED_OBJS               =  \
...
PRODUCT = ./Feedback176Ah_rtwlib.lib
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/slprj/ert/Feedback176Ah -I$(START_DIR) -ID:/Ä£ÐÍ -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=Feedback176Ah -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/Feedback176Ah/Feedback176Ah.c
...
%.obj : $(START_DIR)/slprj/ert/Feedback176Ah/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
