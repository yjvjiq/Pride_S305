###########################################################################
## Makefile generated for Simulink model 'FT176Ah'. 
## 
## Makefile     : FT176Ah.mk
## Generated on : Tue Dec 20 17:38:24 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FT176Ah.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/NEWFOL~2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = FT176Ah_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = FT176Ah_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FT176Ah.exe
...
INCLUDES_BUILDINFO = -I./referenced_model_includes -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/FT176Ah_ert_rtw -I$(START_DIR) -ID:/Ä£ÐÍ -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=FT176Ah -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/FT176Ah_ert_rtw/FT176Ah.c

MAIN_SRC = $(START_DIR)/FT176Ah_ert_rtw/ert_main.c
...
MODELREF_LIBS = ./Feedback176Ah_rtwlib.lib ./SOF176Ah_rtwlib.lib
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) $(subst /,\,$(subst /,\,$(MAIN_OBJ))) @$(MODELREF_LINK_RSPFILE) $(subst /,\,$(subst /,\,$(LIBS))) $(subst /,\,$(subst /,\,$(SYSTEM_LIBS))) $(subst /,\,$(subst /,\,$(TOOLCHAIN_LIBS)))
...
%.obj : $(START_DIR)/FT176Ah_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
