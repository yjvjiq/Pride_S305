...
} B_CellUnderVoltage_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  uint8_T is_active_c3_CellUnderVoltage;/* '<Root>/Logic' */
...
/* Block signals (auto storage) */
extern B_CellUnderVoltage_T CellUnderVoltage_B;
...
extern uint8_T CellUnderVoltage_custom(real32_T Vmin);
