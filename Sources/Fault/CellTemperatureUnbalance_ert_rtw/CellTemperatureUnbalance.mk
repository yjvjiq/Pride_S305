###########################################################################
## Makefile generated for Simulink model 'CellTemperatureUnbalance'. 
## 
## Makefile     : CellTemperatureUnbalance.mk
## Generated on : Sun Dec 11 10:47:33 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\CellTemperatureUnbalance.exe
...
PRODUCT_NAME              = CellTemperatureUnbalance
MAKEFILE                  = CellTemperatureUnbalance.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = CellTemperatureUnbalance_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = CellTemperatureUnbalance_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\CellTemperatureUnbalance.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\CellTemperatureUnbalance_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=CellTemperatureUnbalance -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\CellTemperatureUnbalance_ert_rtw\CellTemperatureUnbalance.c $(START_DIR)\CellTemperatureUnbalance_ert_rtw\CellTemperatureUnbalance_data.c

MAIN_SRC = $(START_DIR)\CellTemperatureUnbalance_ert_rtw\ert_main.c
...
OBJS = CellTemperatureUnbalance.obj CellTemperatureUnbalance_data.obj
...
{$(START_DIR)\CellTemperatureUnbalance_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CellTemperatureUnbalance_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
