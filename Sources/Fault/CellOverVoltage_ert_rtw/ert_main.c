...
#include "CellOverVoltage.h"           /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  /* Check for overrun */
  if (OverrunFlag) {
    rtmSetErrorStatus(CellOverVoltage_M, "Overrun");
    return;
  }
...
int_T main(int_T argc, const char *argv[])
{
  ...
  fflush((NULL));
  while (rtmGetErrorStatus(CellOverVoltage_M) == (NULL)) {
