...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ChargeOverCurrent.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ChargeOverCurrent_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = ChargeOverCurrent_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ChargeOverCurrent.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/ChargeOverCurrent_ert_rtw -I$(START_DIR) -IE:/S305Ä£ÐÍ -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ChargeOverCurrent -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.obj : $(START_DIR)/ChargeOverCurrent_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
